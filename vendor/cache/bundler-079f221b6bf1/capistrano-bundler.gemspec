...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "CHANGELOG.md", "Gemfile", "LICENSE", "LICENSE.txt", "README.md", "Rakefile", "capistrano-bundler.gemspec", "lib/capistrano-bundler.rb", "lib/capistrano/bundler.rb", "lib/capistrano/tasks/bundler.cap"]
